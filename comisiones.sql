...
FROM  "10028_COPPER_ESV"."COMISIONES" T0 
        ...
        LEFT JOIN (select "VENDEDOR", SUM("TOTAL") VENTA from "10028_COPPER_ESV"."VENTAS" 
                   ...
                   WHERE "FECHA" >=  '20250201' AND "FECHA"  <= '20250228'
                   GROUP BY  "VENDEDOR") 
...
WHERE T1."FECHA_PAGO" >=  '20250201' AND "FECHA_PAGO"<='20250228' 
...
---- SE HA TOMADO ESTE
--PANAMA
SELECT *, CASE WHEN T0."GRUPO"='Aire Acondicionado' THEN T0."TOTAL" ELSE 0 END PRECIO_UNITARIO_60,
CASE WHEN T0."GRUPO"!='Aire Acondicionado' THEN T0."TOTAL" ELSE 0 END PRECIO_UNITARIO_40,
CASE WHEN T0."SUCURSAL"='PNM Viejo' THEN T0."TOTAL" ELSE 0 END PNM,
CASE WHEN T0."SUCURSAL"='Vista Hermosa' THEN T0."TOTAL" ELSE 0 END VISTA
FROM VENTAS T0 
WHERE T0."FECHA" >= [%0] and T0."FECHA"<=[%1]
WHERE T0."FECHA" >= {?fechaInicio} and T0."FECHA"<={?fechaFin}
--EL SALVADOR
SELECT *, CASE WHEN T0."GRUPO"='Aire Acondicionado' THEN T0."TOTAL" ELSE 0 END AC,
CASE WHEN T0."GRUPO"!='Aire Acondicionado' THEN T0."TOTAL" ELSE 0 END MISC,
CASE WHEN T0."SUCURSAL"='JUAN PABLO' THEN T0."TOTAL" ELSE 0 END JP,
CASE WHEN T0."SUCURSAL"='MERLIOT' THEN T0."TOTAL" ELSE 0 END ML,
CASE WHEN T0."SUCURSAL"='SAN MIGUEL' THEN T0."TOTAL" ELSE 0 END SM
FROM VENTAS T0 
WHERE T0."FECHA" >= '20250201' and T0."FECHA"<='20250228'
WHERE T0."FECHA" >= {?fechaInicio} and T0."FECHA"<={?fechaFin}


--HACIENDOLO QUEMADO CON SUCURSAL Y FAMILIA
...
FROM VENTAS T0 
--WHERE T0."FECHA" >= {?fechaInicio} and T0."FECHA"<={?fechaFin}
LEFT JOIN (SELECT K1."U_META_SUCURSAL" FROM META_SUCURSAL K1) T1 ON T0."SUCURSAL" = T1."U_META_SUCURSAL"
WHERE T0."FECHA" >= '20250201' and T0."FECHA"<='20250228'
